...
namespace hr {
    class UIElement {
        public:
            ...
            static void IntField(const std::string &label, std::function<int()> getter, std::function<void(int)> setter, float speed = 1.0, float min = 0.0, float max = 0.0, const char* format = "%.3f");
