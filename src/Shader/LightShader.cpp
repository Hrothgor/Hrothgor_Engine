...
void hr::LightShader::UpdateLightLoc(Light *light, int id)
{
    int enabled = 1;
...
void hr::LightShader::UpdateLightsLoc(std::vector<GameObject *> lights)
{
...
std::vector<int> hr::LightShader::GetLocations(int id) const
{
